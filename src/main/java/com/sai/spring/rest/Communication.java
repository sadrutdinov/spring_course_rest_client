...
public class Communication {
    ...
    public void saveEmployee(Employee employee) {
        ...
        if (id == 0) {
            ...
            System.out.println("новый работник добавлен в базу данных");
            System.out.println(responseEntity.getBody());
        }
        else {
            restTemplate.put(URL, employee);
            System.out.println("работник с ID = " + employee.getId() + " обновлен");
        }
    ...
    public void deleteEmployee(int id) {
        ...
        System.out.println("работник с ID = "+ id + " удален из базы");
    }
}
